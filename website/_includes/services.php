<section id="services">
	...
	<div class="treatment-areas">
		<h1 class="top-pad">Treatment Areas of Focus</h1>
		<ul>
			<li>Academic and Behavioral Challenges</li>
			<li>Anxiety</li>
			<li>Attachment building</li>
			<li>Autism (AUTPlay therapy)</li>
			<li>ADHD</li>
			<li>Cognitive-Behavioral work</li>
			<li>Depression</li>
	...
	<a class="meet-brooke" href="#about">Meet Brooke</a>
