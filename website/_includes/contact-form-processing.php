        ...
        <?php
            ...
            $fields_string = '';
            $fields = array(
                'secret' => '6Ld7nFMUAAAAAC0OdRj4-HcfBBeifnmRPNkl3fEA',
...
<?php
    ...
    $my_email = "brookeharris.lpc@gmail.com";
    // for testing
...
<form action="contact.php" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">
    <ul>
        ...
        <li>
           <div class="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6Ld7nFMUAAAAALOV37gFrDLRjknqoSvaOxfRaHwh"></div>
        </li>
        <li>
